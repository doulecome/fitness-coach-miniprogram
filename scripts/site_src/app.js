...
(function () {
  ...
  function vTrain() {
    ...
    var filtered = list.filter(function (a) { return equipOk(a) && (S.actMus === '全部' || (musclesOf(a) || '').indexOf(S.actMus) >= 0) && (!S.actQ || a.name.indexOf(S.actQ) >= 0); });
  ...
  function resetData() {
    ...
    ['fit_best', 'fit_records', 'fit_plan', 'fit_weight', 'fit_dietlog', 'fit_diet', 'fit_badges'].forEach(function (k) { try { localStorage.removeItem(k); } catch (e) {} });
