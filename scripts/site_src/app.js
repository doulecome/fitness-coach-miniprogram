...
(function () {
  ...
  /* 周报分享图（#33）与训练提醒（#37）已于 v39 删除：私人版无分享场景；Web 无推送能力，页面级提醒形同虚设 */
  /* 周报分享图（#33）与训练提醒（#37）已于 v39 删除：私人版无分享场景；Web 无推送能力，页面级提醒形同虚设 */
  ...
  function vRecord() {
    ...
    return healthCard() + heatmap() + trendHtml() + fitTestCard() + prTrendHtml() + weightCard() + radarHtml + volHtml + backup +
